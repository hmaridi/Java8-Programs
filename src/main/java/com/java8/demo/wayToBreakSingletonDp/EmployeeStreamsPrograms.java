...
public class EmployeeStreamsPrograms {
	...
	public static void main(String[] args) {
		...
		employeeList.add(new Employee(199, "Amelia Zoe", 24, "Female", "Sales And Marketing", 2016, 11000.5));
		...
		Map<Double, List<Employee>> sameSalaries = employeeList.stream()
				.collect(Collectors.groupingBy(Employee::getSalary, Collectors.toList()));

		for (Map.Entry<Double, List<Employee>> map : sameSalaries.entrySet()) {
