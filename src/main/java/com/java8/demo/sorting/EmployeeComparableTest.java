...
//		comparableEmployeesList.sort((ce1, ce2) -> ce1.getName().compareTo(ce2.getName()));
//
//		comparableEmployeesList.forEach((x) -> System.out.println("Sort by Name :" + x.getName()));
//
//		comparableEmployeesList.sort((ce1, ce2) -> ce1.getDepartment().compareTo(ce2.getDepartment()));
//
//		comparableEmployeesList.forEach((x) -> System.out.println("Sort by Department :" + x.getDepartment()));
	     
//		comparableEmployeesList.stream().sorted((emp1, emp2) -> emp1.getName().compareToIgnoreCase(emp2.getName()))
//				.forEach(emp -> System.out.println(emp));
		
		comparableEmployeesList.stream().sorted((emp1, emp2) -> Double.compare(emp1.getSalary(), emp2.getSalary()))
				.forEach(emp -> System.out.println(emp));
